# O2Jam Music List — Client v8.02 (O2Jam Classic)

Music list format for the O2Jam Classic client. See [File Format Documentation](../FileFormat.md) for shared conventions and for the [OJN](../FileFormat.md#o2jam-note) header layout referenced here.

This layout is identical to [v5.89 Final](../5.89/OJNList.md).
...
Overrides premium behaviour. Music listed here is excluded from the VIP package.
...
<sup>\* Observed values are constant `244` (`0xF4`) and `67` (`0x43`) respectively.</sup>
...
<sup>2. Observed value is constant `1242928` (`0x12F730`).</sup><br/>
<sup>3. Observed value is constant `4474939` (`0x44483B`).</sup>
