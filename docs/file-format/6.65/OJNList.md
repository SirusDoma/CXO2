# O2Jam Music List — Client v6.65 (O2JamO2)

Music list format for the O2JamO2 client — the non-beta build that has 3K mode. See [File Format Documentation](../FileFormat.md) for shared conventions and for the [OJN](../FileFormat.md#o2jam-note) header layout referenced here.

It is the same client used in O2Solista v0.3, v0.5 and v0.6.
...
<sup>The [Beta](../5.89/OJNList.md#section-6--discount) client uses an 8-byte entry with a single discount field.</sup>
