...
namespace StringTable::Identifiers::Resource::MyRoom
{
    ...
    namespace Status
    {
        constexpr static auto IDC_TEXT_NAME        = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_NAME";
        constexpr static auto IDC_TEXT_LEVEL       = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_LEVEL";
        constexpr static auto IDC_TEXT_EVENT_POINT = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_EVENT_POINT";
        constexpr static auto IDC_TEXT_EXP         = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_EXP";
        constexpr static auto IDC_TEXT_NEXT_EXP    = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_NEXT_EXP";
        constexpr static auto IDC_TEXT_RECORD      = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_RECORD";
        constexpr static auto IDC_TEXT_RANKING     = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_RANKING";
        constexpr static auto IDC_TEXT_GUILD       = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_TEXT_GUILD";
        constexpr static auto IDC_BUTTON_MY_ALBUM  = "STATE_MY_ROOM/IDC_IMAGE_STATUS/IDC_BUTTON_MY_ALBUM";
    }

    namespace SkillInfo
    {
        constexpr static auto IDC_TEXT_ITEM_NAME        = "STATE_MY_ROOM/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_NAME";
        constexpr static auto IDC_TEXT_ITEM_QUANTITY    = "STATE_MY_ROOM/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_QUANTITY";
        constexpr static auto IDC_TEXT_ITEM_SKILL       = "STATE_MY_ROOM/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_SKILL";
        constexpr static auto IDC_TEXT_ITEM_DESCRIPTION = "STATE_MY_ROOM/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_DESCRIPTION";
        constexpr static auto IDC_IMAGE_ITEM_THUMBNAIL  = "STATE_MY_ROOM/IDC_DIALOG_SKILL_INFO/IDC_IMAGE_ITEM_THUMBNAIL";
