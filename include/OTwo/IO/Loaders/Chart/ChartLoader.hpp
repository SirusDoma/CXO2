...
public:
    ...
    static Gx::ResourcePtr<sf::Image> LoadThumbnail(ChartMetadata &metadata, const Gx::ResourceContext &ctx);
    static Gx::ResourcePtr<sf::Image> LoadCoverArt(ChartMetadata &metadata, const Gx::ResourceContext &ctx);
    static Gx::ResourcePtr<sf::Image> LoadThumbnail(sf::InputStream &stream, ChartMetadata &metadata, const Gx::ResourceContext &ctx);
