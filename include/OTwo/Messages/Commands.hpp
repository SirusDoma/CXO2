...
template <>
struct magic_enum::customize::enum_range<RequestCommand>
{
...
template <>
struct magic_enum::customize::enum_range<ResponseCommand>
{
...
template <>
struct magic_enum::customize::enum_range<EventCommand>
{
    static constexpr int min = 1000;
    static constexpr int max = 8000;
};
...
template <>
struct magic_enum::customize::enum_range<GenericCommand>
{
