...
namespace Cx::StringTable::Identifiers::Resource::ItemShop
{
    ...
    {
        constexpr static auto IDC_IMAGE_SHOP_MASTER_MAIN     = "STATE_ITEM_SHOP/IDC_CONTAINER_SHOP_MASTER/IDC_IMAGE_SHOP_MASTER_MAIN";
        constexpr static auto IDC_IMAGE_SHOP_MASTER_O2P      = "STATE_ITEM_SHOP/IDC_CONTAINER_SHOP_MASTER/IDC_IMAGE_SHOP_MASTER_O2P";
        constexpr static auto IDC_IMAGE_SHOP_MASTER_AQUA     = "STATE_ITEM_SHOP/IDC_CONTAINER_SHOP_MASTER/IDC_IMAGE_SHOP_MASTER_AQUA";
    ...
    namespace MyBag
    {
        ...
        namespace Item
        {
            ...
            constexpr static auto IDC_TEXT_QUANTITY   = "IDC_TEXT_QUANTITY";
        }
    }

    namespace Cart
    {
        constexpr static auto IDC_BUTTON_BUY          = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_BUTTON_BUY";
        constexpr static auto IDC_BUTTON_GIFT         = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_BUTTON_GIFT";
        constexpr static auto IDC_LIST_CART           = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_LIST_CART";
        constexpr static auto IDC_NUMBER_CURRENT_PAGE = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_NUMBER_CURRENT_PAGE";
        constexpr static auto IDC_NUMBER_MAX_PAGE     = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_NUMBER_MAX_PAGE";
        constexpr static auto IDC_NUMBER_TOTAL_GEM    = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_NUMBER_TOTAL_GEM";
        constexpr static auto IDC_NUMBER_TOTAL_CASH   = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_NUMBER_TOTAL_CASH";
        constexpr static auto IDC_BUTTON_LEFT         = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_BUTTON_LEFT";
        constexpr static auto IDC_BUTTON_RIGHT        = "STATE_ITEM_SHOP/IDC_CONTAINER_CART/IDC_BUTTON_RIGHT";
    ...
    {
        constexpr static auto IDC_TEXT_NAME      = "IDC_TEXT_NAME";
        constexpr static auto IDC_NUMBER_PRICE   = "IDC_NUMBER_PRICE";
        constexpr static auto IDC_IMAGE_CURRENCY = "IDC_IMAGE_CURRENCY";
        constexpr static auto IDC_BUTTON_ADD     = "IDC_BUTTON_ADD";
        constexpr static auto IDC_BUTTON_PREVIEW = "IDC_BUTTON_PREVIEW";
        constexpr static auto IDC_IMAGE_ITEM     = "IDC_IMAGE_ITEM";
    }

    namespace SetItemList
    {
        constexpr static auto IDC_TEXT_NAME       = "IDC_TEXT_NAME";
        ...
        constexpr static auto IDC_BUTTON_PREVIEW  = "IDC_BUTTON_PREVIEW";
        constexpr static auto IDC_IMAGE_ITEM      = "IDC_IMAGE_ITEM";
        constexpr static auto IDC_LIST_ITEM_PIECE = "IDC_LIST_ITEM_PIECE";
    }

    namespace SkillInfo
    {
        constexpr static auto IDC_TEXT_ITEM_NAME        = "STATE_ITEM_SHOP/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_NAME";
        constexpr static auto IDC_TEXT_ITEM_QUANTITY    = "STATE_ITEM_SHOP/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_QUANTITY";
        constexpr static auto IDC_TEXT_ITEM_SKILL       = "STATE_ITEM_SHOP/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_SKILL";
        constexpr static auto IDC_TEXT_ITEM_DESCRIPTION = "STATE_ITEM_SHOP/IDC_DIALOG_SKILL_INFO/IDC_TEXT_ITEM_DESCRIPTION";
        constexpr static auto IDC_IMAGE_ITEM_THUMBNAIL  = "STATE_ITEM_SHOP/IDC_DIALOG_SKILL_INFO/IDC_IMAGE_ITEM_THUMBNAIL";
