...
namespace Cx::Constants::Messages::Loading
{
    ...
    constexpr static auto MISSION_HEADER      = U"LEVEL {} MISSION";
    constexpr static auto SPEED               = U"{:.1f} x";
    constexpr static auto MISSION_NEEDS_OTHER_TUNE = "With the selected tune the mission cannot be accomplished";
    constexpr static auto MISSION_NEEDS_MULTIPLAY  = "With the single mode the mission cannot be accomplished";
}
