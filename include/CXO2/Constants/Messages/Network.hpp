...
namespace Cx::Constants::Messages::Network
{
    ...
    constexpr static auto UNSTABLE             = "Network is not in a good condition.\nPlease try again a little while later.";
    constexpr static auto UNAVAILABLE          = "Network connection cannot be established.\nPlease try again later."; // Unmapped
}
