...
namespace Cx
{
    ...
    NetworkService::Dispatch(const TMessage& request,
    ...
    template<class TMessage>
    std::enable_if_t<IsMessage<TMessage>::value, void> NetworkService::Dispatch(
    ...
    NetworkService::Dispatch(const TRequest& request,
    ...
    template<class TMessage>
    std::enable_if_t<IsMessage<TMessage>::value, void>
    NetworkService::Acquire(const MessageCallback<TMessage>& callback, const sf::Time timeout)
    {
    ...
    NetworkService::On(const MessageCallback<TMessage>& callback)
    {
    ...
    template<class TRequest, class TResponse>
    std::enable_if_t<IsMessage<TRequest>::value && IsMessage<TResponse>::value, void>
    NetworkService::StartHeartbeat(const sf::Time timeout, const std::function<void(const Gx::Exception&)>& errorCallback)
    {
        Discard<TResponse>();
