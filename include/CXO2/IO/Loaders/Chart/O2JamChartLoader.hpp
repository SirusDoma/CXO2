...
namespace Cx
{
    ...
    public:
        ...
        Gx::ResourcePtr<Chart> LoadFromStream(sf::InputStream& input, const Gx::ResourceContext& ctx) const override;
        ...
        static Gx::ResourcePtr<sf::Image> LoadThumbnail(sf::InputStream& input, const O2JamChartMetadata& metadata, const Gx::ResourceContext& ctx);
        static Gx::ResourcePtr<sf::Image> LoadCoverArt(sf::InputStream& input, const O2JamChartMetadata& metadata, const Gx::ResourceContext& ctx);
        static Gx::ResourcePtr<sf::InputStream> Decrypt(Gx::ResourcePtr<sf::InputStream> stream);
