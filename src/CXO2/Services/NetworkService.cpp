...
namespace Cx
{
    ...
    void NetworkService::Connect(const sf::IpAddress& ipAddress, const unsigned short port,
    ...
    void NetworkService::StopHeartbeat()
    {
    ...
    void NetworkService::Update(const sf::Time& delta)
    {
        if (m_connecting)
        {
