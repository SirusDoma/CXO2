...
namespace Cx
{
    ...
    {
        if (Gx::Renderable::IsVisible() != visible)
        {
            Gx::Renderable::SetVisible(visible);
            Invalidate();
        }
    }
    ...
    Gx::RenderStates Control::Render(Gx::RenderSurface& surface, Gx::RenderStates states) const
    {
        if (!IsVisible())
            return states;
    ...
    bool Control::Input(const sf::Event& ev)
    {
        ...
        return Gx::InputableContainer::Input(ev);
    }
    ...
    void Control::OnMouseMoved(const sf::Event::MouseMoved& ev)
    {
        ...
        Gx::InputableContainer::OnMouseMoved(ev);
    }
    ...
    void Control::OnMouseButtonPressed(const sf::Event::MouseButtonPressed& ev)
    {
        ...
        Gx::InputableContainer::OnMouseButtonPressed(ev);
    }
    ...
    void Control::OnMouseButtonReleased(const sf::Event::MouseButtonReleased& ev)
    {
        ...
        m_doubleClicked = false;
        Gx::InputableContainer::OnMouseButtonReleased(ev);
    }

    void Control::OnChildAdded(Gx::Node& node)
    {
    ...
    void Control::OnChildRemove(Gx::Node& node)
    {
        if (const auto control = dynamic_cast<Control*>(&node); control)
        {
    ...
    void Control::OnMouseWheelScrolled(const sf::Event::MouseWheelScrolled& ev)
    {
        ...
        Gx::Inputable::OnMouseWheelScrolled(ev);
    }
}
