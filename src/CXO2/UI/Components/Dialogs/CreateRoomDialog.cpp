...
namespace Cx
{
    ...
    void CreateRoomDialog::Initialize()
    {
        ...
        const auto titleInput    = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_TITLE);
        const auto passwordInput = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_PASSWORD);

        const auto jamModeButton    = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_JAM_MODE);
        const auto versusModeButton = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_VERSUS_MODE);
        const auto singleModeButton = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_SINGLE_MODE);
        ...
        const auto levelLimitToggleButton = FindChild<Cx::ToggleButton>(Resource::Room::CreateRoom::IDC_TOGGLE_LEVEL_LIMIT);
        const auto minLevelLimitInput     = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_MIN_LEVEL_LIMIT);
        const auto maxLevelLimitInput     = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_MAX_LEVEL_LIMIT);
    ...
    void CreateRoomDialog::OnJamModeButtonClicked(Control& sender, Control::Event& ev)
    {
        const auto parent   = dynamic_cast<Cx::State*>(GetPresentableParent());
        const auto sfxClick = parent->Instantiate<sf::Sound>(Sound::Effects::EF_10);
    ...
    void CreateRoomDialog::OnVersusModeButtonClicked(Control& sender, Control::Event& ev)
    {
        const auto parent   = dynamic_cast<Cx::State*>(GetPresentableParent());
        const auto sfxClick = parent->Instantiate<sf::Sound>(Sound::Effects::EF_10);
    ...
    void CreateRoomDialog::OnSingleModeButtonClicked(Control& sender, Control::Event& ev)
    {
        const auto parent   = dynamic_cast<Cx::State*>(GetPresentableParent());
        const auto sfxClick = parent->Instantiate<sf::Sound>(Sound::Effects::EF_10);
    ...
    void CreateRoomDialog::OnJamModeButtonCheckChanged(Cx::RadioButton& sender, Control::Event& ev)
    {
        if (!sender.IsChecked())
            return;
        ...
        const auto versusModeButton = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_VERSUS_MODE);
        const auto jamAnimation     = jamModeButton->FindChild<Gx::Animation>(Resource::Room::CreateRoom::IDC_ANIMATION_JAM);
        const auto toolTip          = FindChild<Cx::ToolTip>(Resource::Room::CreateRoom::IDC_TOOLTIP_INFO);
    ...
    void CreateRoomDialog::OnVersusModeButtonCheckChanged(Cx::RadioButton& sender, Control::Event& ev)
    {
        const auto versusModeButton = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_VERSUS_MODE);
        const auto versusAnimation  = versusModeButton->FindChild<Gx::Animation>(Resource::Room::CreateRoom::IDC_ANIMATION_VERSUS);
    ...
    void CreateRoomDialog::OnSingleModeButtonCheckChanged(Cx::RadioButton& sender, Control::Event& ev)
    {
        const auto singleModeButton       = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_SINGLE_MODE);
        const auto singleAnimation        = singleModeButton->FindChild<Gx::Animation>(Resource::Room::CreateRoom::IDC_ANIMATION_SINGLE);
        const auto levelLimitToggleButton = FindChild<Cx::ToggleButton>(Resource::Room::CreateRoom::IDC_TOGGLE_LEVEL_LIMIT);
    ...
    void CreateRoomDialog::OnLevelLimitToggleCheckChanged(Cx::ToggleButton& sender, Control::Event& ev)
    {
        const auto minLevelLimitInput = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_MIN_LEVEL_LIMIT);
        const auto maxLevelLimitInput = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_MAX_LEVEL_LIMIT);
    ...
    {
        const auto titleInput = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_TITLE);
        auto passwordInput    = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_PASSWORD);
    ...
    GameMode CreateRoomDialog::GetRoomMode() const
    {
        const auto jamModeButton    = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_JAM_MODE);
        const auto singleModeButton = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_SINGLE_MODE);
        auto versusModeButton       = FindChild<Cx::RadioButton>(Resource::Room::CreateRoom::IDC_RADIO_VERSUS_MODE);
    ...
    {
        if (const auto titleInput = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_TITLE); titleInput)
    ...
    {
        if (const auto passwordInput = FindChild<Cx::InputField>(Resource::Room::CreateRoom::IDC_EDIT_PASSWORD); passwordInput)
