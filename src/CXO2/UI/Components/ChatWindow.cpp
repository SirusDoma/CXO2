...
namespace Cx
{
    ...
    void ChatWindow::SetScrollBar(ScrollBar& scrollBar)
    {
    ...
    void ChatWindow::OnMouseWheelScrolled(const sf::Event::MouseWheelScrolled& ev)
    {
        ...
        if (m_scroll->GetScrollOrientation() == ScrollBar::ScrollOrientation::Vertical)
            delta *= -1;
    ...
    void ChatWindow::OnScrollValueChanged(ScrollBar& sender, ScrollBar::ValueChangedEvent& ev)
    {
