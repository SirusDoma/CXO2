...
namespace Cx
{
    ...
    void ChannelButton::Initialize()
    {
        ...
        m_numberIndicator   = FindChild<BitmapNumber>(Resource::Planet::ChannelBoard::ChannelButton::IDC_NUMBER_CHANNEL_ID);
        m_nameIndicator     = FindChild<Image>(Resource::Planet::ChannelBoard::ChannelButton::IDC_IMAGE_CHANNEL_NAME);
        m_fullIndicator     = FindChild<Image>(Resource::Planet::ChannelBoard::ChannelButton::IDC_IMAGE_CHANNEL_FULL);
        m_focusIndicator    = FindChild<Image>(Resource::Planet::ChannelBoard::ChannelButton::IDC_IMAGE_CHANNEL_FOCUS);
        m_populationCounter = FindChild<Cx::UiContainer>(Resource::Planet::ChannelBoard::ChannelButton::IDC_CONTAINER_CHANNEL_COUNTER);
