...
namespace Cx
{
    ...
    void RoomButton::Invalidate()
    {
        ...
        const auto number         = FindChild<BitmapNumber>(Resource::Room::Button::IDC_NUMBER_ROOM_ID);
        const auto title          = FindChild<Label>(Resource::Room::Button::IDC_TEXT_ROOM_NAME);
        const auto capacity       = FindChild<Label>(Resource::Room::Button::IDC_TEXT_CAPACITY);
        ...
        const auto levelRange     = FindChild<Label>(Resource::Room::Button::IDC_TEXT_LEVEL_RANGE);
        ...
        if (m_room.Random == static_cast<LevelCategory>(0))
        {
            ...
            auto music = FindChild<Label>(Resource::Room::Button::IDC_TEXT_MUSIC_NAME);
            ...
            if (m_music.New)
            {
                ...
                music = FindChild<Label>(Resource::Room::Button::IDC_TEXT_NEW_MUSIC_NAME);
                music->SetVisible(true);
            }
            else
            {
                const auto newMusic = FindChild<Label>(Resource::Room::Button::IDC_TEXT_NEW_MUSIC_NAME);
        ...
        {
            const auto music = FindChild<Label>(Resource::Room::Button::IDC_TEXT_MUSIC_NAME);
            const auto newMusic = FindChild<Label>(Resource::Room::Button::IDC_TEXT_NEW_MUSIC_NAME);
            const auto newIndicator = FindChild<Image>(Resource::Room::Button::IDC_IMAGE_NEW_MUSIC);
