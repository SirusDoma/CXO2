...
namespace Cx
{
    ...
    Gx::BlendMode Image::GetBlendMode() const
    {
        return m_blendMode;
    }
    ...
    void Image::SetBlendMode(const Gx::BlendMode blendMode)
    {
    ...
    Gx::RenderStates Image::Render(Gx::RenderSurface& surface, Gx::RenderStates states) const
    {
        if (!IsVisible())
            return states;
        ...
        return Gx::RenderableContainer::Render(surface, states);
    }
