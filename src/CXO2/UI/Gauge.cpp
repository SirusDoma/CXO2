...
namespace Cx
{
    Gauge::Gauge() :
        ...
        m_slanted(false),
        m_animationState(Gx::Animation::AnimationState::Initial),
        m_currentFrame(0)
    {
    }
    ...
    Gx::Animation::AnimationState Gauge::GetAnimationState() const
    {
        return m_animationState;
    }

    void Gauge::AddAnimationFrame(const Gx::Animation::Frame& frame)
    {
    ...
    void Gauge::Update(const sf::Time& delta)
    {
        ...
        m_animationState    = Gx::Animation::AnimationState::Playing;
    ...
    Gx::RenderStates Gauge::Render(Gx::RenderSurface& surface, Gx::RenderStates states) const
    {
        if (!IsVisible())
            return states;
